...
//       let array = new Array();
//       //fill array with all numbers from 1 to n
//       //for each number from 1-n push into array
//       for(i=1;i<=n;i++){array.push(i)}
//       array.sort();
//       let result = array.findIndex((e)=>e===k) + 1
//     //order the numbers lexographically (limit n)
//     // search the list for number equal to k
