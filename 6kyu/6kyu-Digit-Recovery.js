...
//   let res = '';
//   for(let i = 0 ; i < str.length; i++) {
//     for(const num in alph) {
//       const temp = str.slice(i, i + num.length).split('').sort().join('');
//       if(temp ===  num.split('').sort().join('')) {
//           res += alph[num];
//       }
//     }
//   }
//   return res.length === 0? 'No digits found': res;
// }
