...
// 100≡1(mod13)101≡10(mod13)102≡9(mod13)103≡12(mod13)104≡3(mod13)105≡4(mod13)\begin{aligned} 10^0 &\equiv{1} &{\pmod{13}} \\ 10^1 &\equiv{10} &{\pmod{13}}\\ 10^2 &\equiv{9} &{\pmod{13}}\\ 10^3 &\equiv{12} &{\pmod{13}}\\ 10^4 &\equiv{3} &{\pmod{13}}\\ 10^5 &\equiv{4} &{\pmod{13}}\\ \end{aligned}
// 10
// 0
...
function thirt(n) {
  ...
  const sum = n
    ...
    .split("")
    .reverse()
    .reduce((acc, cur, ind) => acc + cur * nums[ind % 6], 0);
